...
const GRAPH_NODES: NodeMeta[] = [
  ...
  },
  {
    ...
    type: 'agent',
    icon: Cpu,
    description: 'Generates code changes and opens PR',
  },
  {
    id: 'code_review_node',
    label: 'Code Reviewer',
    ...
    type: 'agent',
    icon: ShieldCheck,
    description: 'Runs static analysis & reviews diff',
  },
  {
    id: 'qa_node',
    label: 'QA Engineer',
    ...
    type: 'agent',
    icon: Sparkles,
    description: 'Executes automated test suites in sandbox',
  },
  {
    id: 'gate_pr_human_review',
    label: 'Gate: PR Merge Review',
    role: 'Human Review',
    type: 'gate',
    icon: ShieldCheck,
    description: 'Approve or reject PR merge to main',
  },
  {
    id: 'completed',
    ...
    type: 'end',
    icon: CheckCircle2,
    description: 'Autonomous PR verified, tested and merged',
  },
];
