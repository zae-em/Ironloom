...
```json
{
  ...
  "goals": ["Measurable objective 1", "Measurable objective 2"],
  "targetUsers": ["Primary persona or user segment", "Secondary persona"],
  "successMetrics": ["KPI 1 (e.g. Reduce latency by 40%)", "KPI 2"],
  "assumptions": ["Key assumption 1", "Key assumption 2"],
  "risks": ["Technical or market risk 1", "Risk 2"]
}
```
